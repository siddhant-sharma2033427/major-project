...
import { updateRelay, getRelay,getCaptureImage,UpdateCaptureImage,getmorter,UpdateMorter,getMoisture,getHumidity,getTemp } from '../utils/api'
...
const Home = () => {
    ...
    return (
        <>
            ...
            <div>
                <WaterDropIcon/>{
                    moistureData===0?"Need water":"sufficient water"
                }
            </div>
        </>
    )
